...
export default {
  ...
  methods: {
    ...
    add_coupon:function(){
      let api = `${process.env.HTTPAPI}/api/${process.env.PATHAPI}/admin/coupon`;
      const vm = this;
      ...
      if(vm.is_new){
        ...
        api= `${process.env.HTTPAPI}/api/${process.env.PATHAPI}/admin/coupon/${vm.new_coupon.id}`;
    ...
    del_coupon:function(){
      const api= `${process.env.HTTPAPI}/api/${process.env.PATHAPI}/admin/coupon/${this.delete_id}`;
      const vm = this;
