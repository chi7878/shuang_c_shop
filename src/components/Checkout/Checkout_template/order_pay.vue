...
export default {
  ...
  methods: {
    ordersData:function(){
      const api = `${process.env.VUE_APP_HTTPAPI}/api/${process.env.VUE_APP_PATHAPI}/orders`;
      const vm = this;
    ...
    orderFinish:function(){
      const api = `${process.env.VUE_APP_HTTPAPI}/api/${process.env.VUE_APP_PATHAPI}/pay/${this.order_id}`;
      const vm = this;
